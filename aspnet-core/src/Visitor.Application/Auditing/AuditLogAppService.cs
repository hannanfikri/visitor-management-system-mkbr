...
using Visitor.Auditing.Exporting;
using Visitor.Authorization;
using Visitor.Authorization.Users;
using Visitor.Dto;
using Visitor.EntityHistory;
using EntityHistoryHelper = Visitor.EntityHistory.EntityHistoryHelper;

namespace Visitor.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : VisitorAppServiceBase, IAuditLogAppService
    {
