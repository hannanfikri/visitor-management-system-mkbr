...
using Visitor.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Visitor.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : VisitorAppServiceBase, IDashboardCustomizationAppService
    {
