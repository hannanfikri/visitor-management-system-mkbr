...
using Visitor.Migrations.Seed;
using Visitor.Migrations.Seed.Host;
...
namespace Visitor.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : VisitorAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<VisitorDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{VisitorConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{VisitorConsts.ConnectionStringName}", constring);
        }
