...
using Visitor.MultiTenancy.Payments.Stripe;
using Visitor.MultiTenancy.Payments.Stripe.Dto;
using Stripe;
using Stripe.Checkout;

namespace Visitor.MultiTenancy.Payments
{
    public class StripePaymentAppService : VisitorAppServiceBase, IStripePaymentAppService
    {
