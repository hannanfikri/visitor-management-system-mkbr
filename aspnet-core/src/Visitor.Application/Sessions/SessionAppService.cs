...
{
    public class SessionAppService : VisitorAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = VisitorConsts.Currency,
                        CurrencySign = VisitorConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = VisitorConsts.AllowTenantsToChangeEmailSettings,
