...
namespace Visitor.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : VisitorServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Visitor";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + VisitorConsts.Currency;
        }
