...
{
    public class VisitorMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public VisitorMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(VisitorConsts.LocalizationSourceName, name);
        }
    }
}