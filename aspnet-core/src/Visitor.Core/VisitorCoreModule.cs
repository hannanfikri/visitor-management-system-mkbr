...
using Visitor.Authorization.Ldap;
using Visitor.Authorization.Roles;
using Visitor.Authorization.Users;
using Visitor.Chat;
using Visitor.Configuration;
using Visitor.DashboardCustomization.Definitions;
using Visitor.Debugging;
using Visitor.DynamicEntityProperties;
...
{
    [DependsOn(
        typeof(VisitorCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class VisitorCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            VisitorLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, VisitorMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<VisitorSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(VisitorCoreModule).GetAssembly());
        }
