...
{
    public class SubscriptionPaymentExtensionDataRepository : VisitorRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<VisitorDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
