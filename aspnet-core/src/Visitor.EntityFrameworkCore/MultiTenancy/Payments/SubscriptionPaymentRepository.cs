...
{
    public class SubscriptionPaymentRepository : VisitorRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<VisitorDbContext> dbContextProvider)
