...
{
    public class UserOrganizationUnitRepository : VisitorRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<VisitorDbContext> dbContextProvider)
