...
using Visitor.Core.Base;
using Visitor.Core.Extensions;
using Visitor.Dto;
using Visitor.Types;

namespace Visitor.Queries
{
    public class OrganizationUnitQuery : VisitorQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
