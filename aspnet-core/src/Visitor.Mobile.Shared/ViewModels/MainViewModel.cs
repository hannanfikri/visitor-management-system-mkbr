...
using Visitor.Services.Navigation;
...
using Visitor.UI;
using Visitor.UI.Assets;
using Visitor.Views;
using DependencyResolver = Visitor.Core.Dependency.DependencyResolver;
...
namespace Visitor.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Visitor";
