...
namespace Visitor.Web.Authentication.JwtBearer
{
    public class VisitorAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public VisitorAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
