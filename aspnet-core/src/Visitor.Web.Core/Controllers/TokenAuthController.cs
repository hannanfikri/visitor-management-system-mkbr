...
using Visitor.Authentication.TwoFactor;
using Visitor.Authentication.TwoFactor.Google;
...
using Visitor.Web.Authentication.JwtBearer;
using Visitor.Web.Authentication.TwoFactor;
using Visitor.Web.Models.TokenAuth;
using Visitor.Authorization.Impersonation;
using Visitor.Authorization.Roles;
using Visitor.Configuration;
using Visitor.Identity;
using Visitor.Net.Sms;
using Visitor.Notifications;
using Visitor.Security.Recaptcha;
using Visitor.Web.Authentication.External;
...
namespace Visitor.Web.Controllers
{
    ...
    public class TokenAuthController : VisitorControllerBase
    {
