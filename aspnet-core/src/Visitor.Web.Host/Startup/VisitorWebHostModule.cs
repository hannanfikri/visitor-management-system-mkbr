...
using Visitor.Auditing;
using Visitor.Authorization.Users.Password;
using Visitor.Configuration;
using Visitor.EntityFrameworkCore;
using Visitor.MultiTenancy;
using Visitor.Web.Startup.ExternalLoginInfoProviders;
...
namespace Visitor.Web.Startup
{
    ...
    public class VisitorWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public VisitorWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(VisitorWebHostModule).GetAssembly());
        }
