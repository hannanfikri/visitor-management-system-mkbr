...
namespace Visitor.Web.Public.Startup
{
    [DependsOn(
        typeof(VisitorWebCoreModule)
    )]
    public class VisitorWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public VisitorWebFrontEndModule(IWebHostEnvironment env, VisitorEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(VisitorWebFrontEndModule).GetAssembly());
        }
    }
}
