...
using Visitor.Url;
using Visitor.Web.Public.Startup;
using Visitor.Web.Session;

namespace Visitor.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : VisitorViewComponent
    {
