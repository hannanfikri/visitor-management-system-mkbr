...
using Visitor.MultiTenancy.HostDashboard;
...
namespace Visitor.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(VisitorDbContext context, SubscriptionPayment subscriptionPayment)
        {
